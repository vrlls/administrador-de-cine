 ...
 * @author usuario
 */
public class TableCR extends javax.swing.JFrame {
   ...
   private void propiedadesTabla(){
    ...
    public TableCR(File pelin) throws IOException {
        initComponents();
        propiedadesTabla();
    ...
    public void selected(){
        ...
        if (jb.getIcon().toString().contains("ocupado.png")) {
            ...
            if (jb.getIcon().toString().contains("libre.png")) {
                JOptionPane.showMessageDialog(null, "el asiento no esta reservado");
       ...
       Metodos m= new Metodos();
        ...
        try {
           Nodo ptr= m.agregarNodosSillas(jTable1);
            ...
            Logger.getLogger(TableCR.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TableCR.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
